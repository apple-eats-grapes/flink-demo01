 ...
 */
public class Hello17TVFCumulate {
    public static void main(String[] args) {
        ...
        //         "    CUMULATE(TABLE t_goods, DESCRIPTOR(ts), INTERVAL '5' SECONDS, INTERVAL '30' SECONDS));").execute().print();

        //查询表信息
        // tableEnvironment.sqlQuery("SELECT window_start, window_end, SUM(sales)\n" +
        //         "  FROM TABLE(\n" +
        //         "    CUMULATE(TABLE t_goods, DESCRIPTOR(ts), INTERVAL '5' SECONDS, INTERVAL '30' SECONDS))\n" +
